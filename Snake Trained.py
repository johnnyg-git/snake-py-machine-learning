...
def main(g,config):
    ...
    while run:
        ...
        text2 = font2.render("This took 10 minutes to train :)", True, (255,0,0))
    ...
    with gzip.open("trainedData") as f:
        gnome = pickle.load(f)
        main(gnome, neat.config.Config(neat.DefaultGenome,neat.DefaultReproduction, neat.DefaultSpeciesSet, neat.DefaultStagnation, config_path))
